...

{
  ...
  echo "- t2helix: e595cd4 (integration commit; interpretation superseded per HQ review 2026-07-04, SHA retained; Grok seat granted by Anthony as policy decision 2026-07-03, subordinate provenance compute with explicit human gate)"
  echo
