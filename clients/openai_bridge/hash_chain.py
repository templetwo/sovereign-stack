...
"""
Hash chain for the OpenAI bridge audit trail.

Every proposal and audit event hashes the previous entry.
A broken chain is evidence of tampering or corruption.
"""
...
AUDIT_DIR = Path.home() / ".sovereign" / "openai_bridge" / "audit"
...
def get_last_audit_hash() -> str | None:
    ...
    try:
        ...
        logger.warning("Could not read audit log for last hash")
        return None
...
def verify_chain() -> tuple[bool, str]:
    ...
    for lineno, entry in entries:
        ...
        prev_hash = stored_hash  # noqa: F841
