...
CONSCIOUSNESS_ROOT = os.environ.get(
    "SOVEREIGN_CONSCIOUSNESS", str(Path.home() / ".sovereign" / "consciousness")
)
...
async def handle_consciousness_tool(name: str, arguments: dict, session_id: str):
    ...
    if name == "record_collaborative_insight":
        ...
        emoji = {"claude": "🤖", "user": "👤", "collaborative": "🌀"}.get(discovered_by, "💡")
    ...
    if name == "end_session_review":
        ...
        meta.end_session_review(session_id, duration, tool_calls, went_well, struggled, learned)
