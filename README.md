...
[![Tests](https://github.com/templetwo/sovereign-stack/actions/workflows/test.yml/badge.svg)](https://github.com/templetwo/sovereign-stack/actions/workflows/test.yml) [![Availability Witness](https://github.com/templetwo/sovereign-stack/actions/workflows/availability-witness.yml/badge.svg)](https://github.com/templetwo/sovereign-stack/actions/workflows/availability-witness.yml) ![Python](https://img.shields.io/badge/python-3.10%20%7C%203.11%20%7C%203.12-blue) ![License](https://img.shields.io/badge/license-CC%20BY--NC--SA%204.0-green) ![Status](https://img.shields.io/badge/status-production-success)
...
![Version](https://img.shields.io/badge/version-1.21.0-purple) ![Tools](https://img.shields.io/badge/tools-100-orange)
...
are allowed to stay — they were true once, and the record should say when.
...
registry that leaves the machine at all — every other one targets `127.0.0.1`,
...
Each of these was required to demonstrably FAIL before it was trusted — a gate
...
| Module | Purpose |
|--------|---------|
| `server.py` | Unified MCP server — registers every tool in the live registry |
